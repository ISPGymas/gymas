  ...
  return (
    <Formik
      ...
      validationSchema={yup.object({
        ...
        activity: yup
          .string()
          .oneOf(Object.values(ActivityLevelEnum))
          .required(),
        membership: yup
          .string()
          .oneOf(Object.values(MembershipType))
          .required(),
        ...
        <form onSubmit={formik.handleSubmit}>
          <SimpleGrid columns={2} columnGap={3} rowGap={6} w='full'>
            ...
            <GridItem colSpan={colSpan}>
              <Button
                variant={
                  formik.values.gender === GenderEnum.MALE
                    ? 'primary'
                    : 'secondary'
                }
                width='full'
            ...
            <GridItem colSpan={colSpan}>
              <Button
                variant={
                  formik.values.gender === GenderEnum.FEMALE
                    ? 'primary'
                    : 'secondary'
                }
                width='full'
            ...
            <GridItem colSpan={colSpan}>
              <Button
                variant={
                  formik.values.membership === MembershipType.BASIC
                    ? 'primary'
                    : 'secondary'
                }
                width='full'
                mt={4}
                onClick={() =>
                  formik.setFieldValue('membership', MembershipType.BASIC)
                }
              >
                Basic
              </Button>
            ...
            <GridItem colSpan={colSpan}>
              <Button
                variant={
                  formik.values.membership === MembershipType.PREMIUM
                    ? 'primary'
                    : 'secondary'
                }
                width='full'
                mt={4}
                onClick={() =>
                  formik.setFieldValue('membership', MembershipType.PREMIUM)
                }
              >
                Premium
              </Button>
            ...
            <GridItem colSpan={2} textAlign='center'>
              ...
              <SelectField
                name={`activity`}
                values={Object.values(ActivityLevelEnum)}
              />
            </GridItem>
            <GridItem colSpan={colSpan}>
              <TextField
                name='alergies'
                label='Alergies'
                placeholder='Please enter alergies'
                isRequired={false}
              />
            </GridItem>
            <GridItem colSpan={colSpan}>
